    ...
    <div className="w-full flex justify-between items-center">
      <div className="mx-auto w-1/4">
        ...
        <form onSubmitCapture={handleSubmit}>
          ...
          <button
            className="w-full py-3 mt-3 text-white text-xl rounded-lg bg-blue-300 hover:bg-blue-600 duration-500"
            type="submit"
          >
            Sign In
          </button>
          <div className="text-xl m-3 flex justify-center text-blue-900 gap-4">
